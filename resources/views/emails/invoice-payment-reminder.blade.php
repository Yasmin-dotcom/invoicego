...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    ...
    <div style="background-color: #f59e0b; color: white; padding: 20px; text-align: center; border-radius: 8px 8px 0 0;">
        <h1 style="margin: 0; font-size: 24px;">Invoice SaaS</h1>
    </div>
    ...
    <div style="background-color: #f9fafb; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 8px 8px;">
        ...
        <p>This is a friendly reminder that your invoice payment is pending. Please find the details below:</p>
        ...
        @if($status !== 'PAID')
            <div style="text-align: center; margin: 30px 0;">
                <a 
                    ...
                    style="display:inline-block;background:#16a34a;color:#ffffff;padding:14px 35px;text-decoration:none;border-radius:6px;font-weight:bold;"
                >
                    Pay Now
                </a>
            </div>
